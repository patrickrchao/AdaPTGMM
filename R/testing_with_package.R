...
all_data <- generate_data(num_data_points,num_df= 4,num_classes = 3,interval=interval)
...
colnames(gmm_log) <- c("FDPHat","Accepted","Rejected")
gmm_log$Type <- "GMM"
